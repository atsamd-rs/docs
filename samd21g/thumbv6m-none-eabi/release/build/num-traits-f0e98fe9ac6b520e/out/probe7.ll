...
start:
  ...
  br i1 %0, label %panic.i, label %"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17hf50d1915c6bcf262E.exit"

panic.i:                                          ; preds = %start
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h9e45ae540d94f469E(ptr align 1 @str.0, i32 25, ptr align 4 @alloc4) #3
  unreachable

"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17hf50d1915c6bcf262E.exit": ; preds = %start
  br label %bb1

bb1:                                              ; preds = %"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17hf50d1915c6bcf262E.exit"
  ret void
}
...
declare dso_local void @_ZN4core9panicking5panic17h9e45ae540d94f469E(ptr align 1, i32, ptr align 4) unnamed_addr #2
